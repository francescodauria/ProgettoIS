...
public class FirmaProgFormTutorAzFragment extends Fragment {
    ...
    private ImageView imageIstanza;
                                ...
                                case DialogInterface.BUTTON_POSITIVE:
                                    ...
                                    if (netInfo != null && netInfo.isConnected()) {
                                        if (itemView.getId() == R.id.accettaTutorAc) {
                                            ...
                                            if(progetto.getGetFirmaTutorAz()==null){
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == 1) {
            if (resultCode == Activity.RESULT_OK) {
                ...
                adapter.getItem(position).setGetFirmaTutorAz(bitmap);
    ...
    class LoadIconTask extends AsyncTask<Integer, Integer, ArrayList<ProgFormativo>> {
        ...
        protected ArrayList<ProgFormativo> doInBackground(Integer... img_ids) {
            ...
            String CF = b.getString("cftutoraz");
            ...
            progetti = ProgettoFormativoDAO.findAllByTutorAziendale(tutorAz);
            return progetti;
    ...
    class AccettaProgettoTask extends AsyncTask<ProgFormativo, Integer, String> {
        ...
        protected String doInBackground(ProgFormativo... progFormativo) {
            ...
            ProgettoFormativoDAO.setConnectionPool(TutorAcActivity.pool);
            String s = null;
            s= ProgettoFormativoDAO.insertFirmaByTutorAziendale(progFormativo[0]);
